...
[MATLAB Coder 产品描述](#matlab-coder-产品描述) [1-2](#matlab-coder-产品描述)

[关于 MATLAB Coder](#关于-matlab-coder) [1-3](#关于-matlab-coder)

[何时使用 MATLAB Coder](#何时使用-matlab-coder) [**1-3**](#何时使用-matlab-coder)

[使用工程界面可以做什么](#使用工程界面可以做什么) [**1-3**](#使用工程界面可以做什么)

[何时使用命令行（codegen 函数）](#何时使用命令行codegen-函数) [**1-3**](#何时使用命令行codegen-函数)

[嵌入式软件应用程序的代码生成](#嵌入式软件应用程序的代码生成) [1-4](#嵌入式软件应用程序的代码生成)

[定点算法的代码生成](#定点算法的代码生成) [1-5](#定点算法的代码生成)

[安装必备产品](#安装必备产品) [1-6](#安装必备产品)

[相关产品](#相关产品) [1-7](#相关产品)

[设置 C 或 C++ 编译器](#设置-c-或-c-编译器) [1-8](#设置-c-或-c-编译器)

[期望背景](#期望背景) [1-9](#期望背景)

[代码生成工作流](#代码生成工作流) [1-10](#代码生成工作流)

[另请参阅](#另请参阅-2) [1-10](#另请参阅-2)

[代码生成的输入类型设定](#代码生成的输入类型设定) [1-11](#代码生成的输入类型设定)

[生成代码和 MATLAB 代码的形式差异](#生成代码和-matlab-代码的形式差异) [1-13](#生成代码和-matlab-代码的形式差异)

[将 MATLAB 函数映射到 C/C++ 函数](#将-matlab-函数映射到-cc-函数) [**1-13**](#将-matlab-函数映射到-cc-函数)

[函数输出的表示形式](#函数输出的表示形式) [1-13](#函数输出的表示形式)

[在生成的代码中删除的常量值](#在生成的代码中删除的常量值) [1-14](#在生成的代码中删除的常量值)

[访问矩阵元素](#访问矩阵元素) [1-15](#访问矩阵元素)

[数学运算和其他函数调用](#数学运算和其他函数调用) [1-15](#数学运算和其他函数调用)

[可变大小数组](#可变大小数组) [1-15](#可变大小数组)

[生成代码中的局部变量](#生成代码中的局部变量) [1-15](#生成代码中的局部变量)

[生成代码中的元胞数组](#生成代码中的元胞数组) [1-15](#生成代码中的元胞数组)

[初始化函数和终止函数](#初始化函数和终止函数) [1-15](#初始化函数和终止函数)

[教程](#教程)

[2](#教程)

[使用 MATLAB Coder App 生成 C 代码](#使用-matlab-coder-app-生成-c-代码) [2-2](#使用-matlab-coder-app-生成-c-代码)

[教程文件](#教程文件) [2-2](#教程文件)

[为 MATLAB 函数生成 C 代码](#为-matlab-函数生成-c-代码) [**2-3**](#为-matlab-函数生成-c-代码)

[为可变大小输入生成 C 代码](#为可变大小输入生成-c-代码) [2-13](#为可变大小输入生成-c-代码)

[接下来的步骤](#接下来的步骤) [2-14](#接下来的步骤)

[通过命令行生成 C 代码](#通过命令行生成-c-代码) [2-16](#通过命令行生成-c-代码)

[教程文件](#教程文件-1) [2-16](#教程文件-1)

[为 MATLAB 函数生成 C 代码](#为-matlab-函数生成-c-代码-1) [**2-17**](#为-matlab-函数生成-c-代码-1)

[为可变大小输入生成 C 代码](#为可变大小输入生成-c-代码-1) [2-22](#为可变大小输入生成-c-代码-1)

[接下来的步骤](#接下来的步骤-1) [2-22](#接下来的步骤-1)

[通过生成 MEX 函数加快 MATLAB 算法的执行速度](#通过生成-mex-函数加快-matlab-算法的执行速度) [2-24](#通过生成-mex-函数加快-matlab-算法的执行速度)

[教程文件](#教程文件-2) [2-24](#教程文件-2)

[为 MATLAB 函数生成 MEX 函数](#为-matlab-函数生成-mex-函数) [**2-25**](#为-matlab-函数生成-mex-函数)

[为可变大小输入生成 MEX 函数](#为可变大小输入生成-mex-函数) [**2-28**](#为可变大小输入生成-mex-函数)

[接下来的步骤](#接下来的步骤-2) [2-30](#接下来的步骤-2)

[Hello World](#hello-world) [2-31](#hello-world)

[为平均值滤波器生成代码](#为平均值滤波器生成代码) [2-32](#为平均值滤波器生成代码)

[代码生成指南：生成可部署的 C/C++ 代码](#代码生成指南生成可部署的-cc-代码) [2-37](#代码生成指南生成可部署的-cc-代码)

[准备 MATLAB 代码以进行代码生成](#准备-matlab-代码以进行代码生成) [2-40](#准备-matlab-代码以进行代码生成)

[初始化变量以进行代码生成](#初始化变量以进行代码生成) [2-40](#初始化变量以进行代码生成)

[筛查包含不支持的函数和语言功能的代码](#筛查包含不支持的函数和语言功能的代码) [**2-40**](#筛查包含不支持的函数和语言功能的代码)

[提示](#提示) [2-41](#提示)

[从 MATLAB 代码生成 C/C++ 代码](#从-matlab-代码生成-cc-代码) [2-42](#从-matlab-代码生成-cc-代码)

[指定输入类型](#指定输入类型) [2-42](#指定输入类型)

[检查运行时问题](#检查运行时问题-2) [2-42](#检查运行时问题-2)

[配置代码生成编译设置](#配置代码生成编译设置) [2-42](#配置代码生成编译设置)

[生成独立的 C/C++ 代码](#生成独立的-cc-代码) [2-42](#生成独立的-cc-代码)

[了解生成的代码](#了解生成的代码) [2-43](#了解生成的代码)

[提示](#提示-1) [2-44](#提示-1)

[测试生成的 C/C++ 代码](#测试生成的-cc-代码) [2-46](#测试生成的-cc-代码)

[测试 MEX 代码以验证行为](#测试-mex-代码以验证行为) [2-46](#测试-mex-代码以验证行为)

[通过使用软件在环和处理器在环测试独立代码](#通过使用软件在环和处理器在环测试独立代码) [**2-46**](#通过使用软件在环和处理器在环测试独立代码)

[提示](#提示-2) [2-46](#提示-2)

[部署生成的 C/C++ 代码](#部署生成的-cc-代码) [2-48](#部署生成的-cc-代码)

[编辑生成的主函数和接口](#编辑生成的主函数和接口) [2-48](#编辑生成的主函数和接口)

[使用 MATLAB Coder 编译可执行应用程序](#使用-matlab-coder-编译可执行应用程序) [**2-49**](#使用-matlab-coder-编译可执行应用程序)

[目标特定代码生成](#目标特定代码生成) [2-49](#目标特定代码生成)

[提示](#提示-3) [2-49](#提示-3)

[[使用 MATLAB Coder 的最佳做法]{.underline}](#使用-matlab-coder-的最佳做法)

[3](#使用-matlab-coder-的最佳做法)

[推荐的 codegen 编译选项](#推荐的-codegen-编译选项) [3-2](#推荐的-codegen-编译选项)

[-c 只生成代码](#c-只生成代码) [3-2](#c-只生成代码)

[-report 生成代码生成报告](#report-生成代码生成报告) [**3-2**](#report-生成代码生成报告)

[在 MATLAB 中测试 MEX 函数](#在-matlab-中测试-mex-函数-1) [3-3](#在-matlab-中测试-mex-函数-1)

[使用 MATLAB 编辑器中的平铺功能比较 C 代码和 MATLAB 代码](#使用-matlab-编辑器中的平铺功能比较-c-代码和-matlab-代码) [3-4](#使用-matlab-编辑器中的平铺功能比较-c-代码和-matlab-代码)

[使用编译脚本](#使用编译脚本) [3-5](#使用编译脚本)

[使用 MATLAB 代码分析器检查代码](#使用-matlab-代码分析器检查代码) [3-6](#使用-matlab-代码分析器检查代码)

[将测试平台与函数代码分离](#将测试平台与函数代码分离) [3-7](#将测试平台与函数代码分离)

[保留您的代码](#保留您的代码) [3-8](#保留您的代码)

[文件命名约定](#文件命名约定) [3-9](#文件命名约定)

# 产品概述

-   ["MATLAB Coder 产品描述" （第 1-2 页）](#matlab-coder-产品描述)

-   ["关于 MATLAB Coder" （第 1-3 页）](#关于-matlab-coder)

-   ["嵌入式软件应用程序的代码生成" （第 1-4 页）](#嵌入式软件应用程序的代码生成)

-   ["定点算法的代码生成" （第 1-5 页）](#定点算法的代码生成)

-   ["安装必备产品" （第 1-6 页）](#安装必备产品)

-   ["相关产品" （第 1-7 页）](#相关产品)

-   ["设置 C 或 C++ 编译器" （第 1-8 页）](#设置-c-或-c-编译器)

-   ["期望背景" （第 1-9 页）](#期望背景)

-   ["代码生成工作流" （第 1-10 页）](#代码生成工作流)

-   ["代码生成的输入类型设定" （第 1-11 页）](#代码生成的输入类型设定)

-   ["生成代码和 MATLAB 代码的形式差异" （第 1-13 页）](#生成代码和-matlab-代码的形式差异)
...
-   ["使用 MATLAB Coder App 生成 C 代码" （第 2-2 页）](#使用-matlab-coder-app-生成-c-代码)
...
-   ["通过命令行生成 C 代码" （第 2-16 页）](#通过命令行生成-c-代码)

-   ["通过生成 MEX 函数加快 MATLAB 算法的执行速度" （第 2-24 页）](#通过生成-mex-函数加快-matlab-算法的执行速度)
...
-   ["将 MATLAB 函数映射到 C/C++ 函数" （第 1-13 页）](#将-matlab-函数映射到-cc-函数)

-   ["函数输出的表示形式" （第 1-13 页）](#函数输出的表示形式)

-   ["在生成的代码中删除的常量值" （第 1-14 页）](#在生成的代码中删除的常量值)

-   ["访问矩阵元素" （第 1-15 页）](#访问矩阵元素)

-   ["数学运算和其他函数调用" （第 1-15 页）](#数学运算和其他函数调用)

-   ["可变大小数组" （第 1-15 页）](#可变大小数组)

-   ["生成代码中的局部变量" （第 1-15 页）](#生成代码中的局部变量)

-   ["生成代码中的元胞数组" （第 1-15 页）](#生成代码中的元胞数组)

-   ["初始化函数和终止函数" （第 1-15 页）](#初始化函数和终止函数)
...
-   ["为平均值滤波器生成代码" （第 2-32 页）](#为平均值滤波器生成代码)

-   ["代码生成指南：生成可部署的 C/C++ 代码" （第 2-37 页）](#代码生成指南生成可部署的-cc-代码)

-   ["准备 MATLAB 代码以进行代码生成" （第 2-40 页）](#准备-matlab-代码以进行代码生成)

-   ["从 MATLAB 代码生成 C/C++ 代码" （第 2-42 页）](#从-matlab-代码生成-cc-代码)

-   ["测试生成的 C/C++ 代码" （第 2-46 页）](#测试生成的-cc-代码)

-   ["部署生成的 C/C++ 代码" （第 2-48 页）](#部署生成的-cc-代码)
...
您还可以使用 **codegen** 命令在 MATLAB [命令行中生成代码。有关此工作流的教程，请参阅"通过命令行生成 C 代码" （第 2-16](#通过命令行生成-c-代码) 页）。
...
>> **注意** 在从您的 MATLAB 代码生成独立的 C/C++ 代码之前，请生成 MEX 函数。运行生成的 MEX 函数，并确保它具有与您的 MATLAB 函数相同的运行时行为。如果生成的 MEX 函数的执行结果不同于 MATLAB的结果，或者出错，您必须先修复这些问题，然后生成独立的代码。否则，您生成的独立代码可能不可靠[并且具有未定义的行为。]{.underline}
...
您还可以使用 MATLAB Coder App 生成代码。有关此工作流的教程，请参阅"使用 [MATLAB Coder](#使用-matlab-coder-app-生成-c-代码) [App 生成 C 代码" （第 2-2](#使用-matlab-coder-app-生成-c-代码) 页）。
...
-   编译脚本 **build_lib_fixed.m** 和 **build_lib_variable.m** 包含的命令可从您的 MATLAB 代码生成静态 C 库，这两个库分别接受固定大小和可变大小输入。这些脚本的内容显示在本教程后面有关生成 C代码的部分中。
...
>> **const double x\[3\]** 对应于您的 MATLAB 代码中的输入 **x**。**x** 的大小是 **3**，它对应于您在为 MATLAB生成代码时使用的示例输入的总大小 (3×1)。
...
您可以使用 MATLAB Coder 从 MATLAB 代码生成 MEX 函数。MEX 函数是一个 MATLAB 可执行文件。它是可以从 MATLAB 内部调用的生成代码。在 MATLAB 环境内工作时，使用 MEX 函数可加快 MATLAB代码的计算密集型部分的执行速度。通过使用 MATLAB Coder App 或在 MATLAB 命令行中使用 **codegen**，从您的 MATLAB 代码生成一个 MEX 函数。
...
-   编译脚本 **build_mex_fixed.m** 和 **build_mex_variable.m** 包含的命令可从您的 MATLAB 代码生成静态 C 库，这两个库分别接受固定大小和可变大小输入。这些脚本的内容显示在本教程后面有关生成 C代码的部分中。
...
要开始本教程，请参阅"准备 [MATLAB 代码以进行代码生成" （第 2-40](#准备-matlab-代码以进行代码生成) 页）。

### 另请参阅相关示例

-   ["准备 MATLAB 代码以进行代码生成" （第 2-40 页）](#准备-matlab-代码以进行代码生成)

-   ["指定输入类型" （第 2-42 页）](#指定输入类型)

-   ["配置代码生成编译设置" （第 2-42 页）](#配置代码生成编译设置)
...
有关详细信息，请参阅"代码生成的输入类型设定" [（第 1-11](#代码生成的输入类型设定) 页）。
...
代码生成器提供了一个示例主函数，供您在生成静态或动态库时参考。请参阅"在应用程序中使用示例 C主函数"。
...
-   ["推荐的 codegen 编译选项" （第 3-2 页）](#推荐的-codegen-编译选项)

-   ["在 MATLAB 中测试 MEX 函数" （第 3-3 页）](#在-matlab-中测试-mex-函数-1)

-   ["使用 MATLAB 编辑器中的平铺功能比较 C 代码和 MATLAB 代码" （第 3-4 页）](#使用-matlab-编辑器中的平铺功能比较-c-代码和-matlab-代码)

-   ["使用编译脚本" （第 3-5 页）](#使用编译脚本)

-   ["使用 MATLAB 代码分析器检查代码" （第 3-6 页）](#使用-matlab-代码分析器检查代码)

-   ["将测试平台与函数代码分离" （第 3-7 页）](#将测试平台与函数代码分离)

-   ["保留您的代码" （第 3-8 页）](#保留您的代码)

-   ["文件命名约定" （第 3-9 页）](#文件命名约定)
...
在进行进一步修改之前保留您的代码。这种做法可在出现错误时提供一条退路，并可提供测试和验证的基线。使用一致的文件命名约定。例如，向序列中每个文件的文件名添加一个两位数后缀。有关详细信息，请参阅"文件命名约定" [（第 3-9](#文件命名约定) 页）。
